...
export const updateWeather = function (lat, lon) {
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        <h2 class="title-2 card-title">Now</h2>
                            <div class="weapper">
                                ...
                                <img src="./assets/images/weather_icons/${icon}.png"
                                    alt="${description}"
                                    width="64" height="64" class="weather-icon">
                            </div>
        ...
        fetchData(url.airPollution(lat, lon), function (airPollution) {
            ...
            card.innerHTML = `
            <h2 class="title-2" style="color:white;" id="highlights-label">Today
            Highlights</h2>
        <div class="highlight-list">
                ...
                <div class="wrapper">
                    ...
                    <ul class="card-list">
                        <li class="card-item">
                            ...
                            <p
                                class="label-1">PM<sub>2.5</sub></p>
                        </li>
                        <li class="card-item">
                            <p class="title-1">${so2.toPrecision(3)}</p>
                            <p
                                class="label-1">SO<sub>2</sub></p>
                        </li>
                        <li class="card-item">
                            <p class="title-1">${no2.toPrecision(3)}</p>
                            <p
                                class="label-1">NO<sub>2</sub></p>
                        </li>
                        <li class="card-item">
                            <p class="title-1">${o3.toPrecision(3)}</p>
                            <p
                                class="label-1">O<sub>3</sub></p>
                        </li>
                    </ul>
                </div>
            ...
            <div class="card card-sm highlight-card">
                ...
                <div class="wrapper">
                    <span
                        class="m-icon">humidity_percentage</span>
            ...
            <div class="card card-sm highlight-card">
                ...
                <div class="wrapper">
                    ...
                    <p
                        class="title-1">${pressure}<sub>hPa</sub></p>
                </div>
        ...
        fetchData(url.forecast(lat, lon), function (forecast) {
            ...
            for (const [index, data] of forecastList.entries()) {
                ...
                <img
                    ...
                    alt="${description}" loading="lazy" width="48"
                    height="48" class="weather-icon"
                    title="${description}">
            ...
            forecastSection.innerHTML = `
            <h2 class="title-2" id="forecast-label">5 Days
            Forecast</h2>
